...
import time
import random
from utils.transformations import quaternion_from_euler, euler_matrix, random_quaternion, quaternion_matrix
...
class PoseDataset(data.Dataset):
    def __init__(self, mode, num_pt, add_noise, root, noise_trans, refine):
        if mode == 'train':
            self.path = 'dataset/ycb/dataset_config/train_data_list.txt'
        elif mode == 'test':
            self.path = 'dataset/ycb/dataset_config/test_data_list.txt'
        self.num_pt = num_pt
        self.root = root
